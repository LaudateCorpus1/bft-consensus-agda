...
module executeAndInsertBlockESpec (bs0 : BlockStore) (block : Block) where
  ...
  proj₁ contract' getBlock≡nothing = contract₁
    ...
    proj₂ (proj₂ contract₁ bsr bsr≡) btr<br = contract₂
      ...
      -- TODO-2: The structure of this proof changes, and therefore it breaks, when we implement
      -- executeBlockE properly.  This suggests that we should be using the contract for
